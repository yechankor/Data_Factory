...
## 키워드 : 커피전문점
remdr$navigate("https://news.joins.com/Search/JoongangNews?StartSearchDate=2020.01.01&EndSearchDate=2020.01.31&Keyword=%EC%BB%A4%ED%94%BC%EC%A0%84%EB%AC%B8%EC%A0%90&SortType=Accuracy&SearchCategoryType=JoongangNews&PeriodType=DirectInput&ScopeType=All&ServiceCode=&SourceGroupType=&ReporterCode=&ImageType=All&JplusType=All&BlogType=All&ImageSearchType=Image&MatchKeyword=&IncludeKeyword=&ExcluedeKeyword=")
source<-remdr$getPageSource()[[1]]
html<-read_html(source)
url<-c()
for (i in 1:5){
...
## 키워드 : 주점
remdr$navigate("https://news.joins.com/Search/JoongangNews?StartSearchDate=2020.01.01&EndSearchDate=2020.01.31&Keyword=%EC%A3%BC%EC%A0%90&SortType=Accuracy&SearchCategoryType=JoongangNews&PeriodType=DirectInput&ScopeType=All&ServiceCode=&SourceGroupType=&ReporterCode=&ImageType=All&JplusType=All&BlogType=All&ImageSearchType=Image&MatchKeyword=&IncludeKeyword=&ExcluedeKeyword=")
source<-remdr$getPageSource()[[1]]
html<-read_html(source)
url<-c()
for (i in 1:5){
...
write(article_body, "C:/data/food202001.txt")

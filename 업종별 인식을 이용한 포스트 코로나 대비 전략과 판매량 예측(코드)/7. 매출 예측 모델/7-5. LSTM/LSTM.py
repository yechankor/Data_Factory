...
font_name= font_manager.FontProperties(fname="/Library/fonts/NanumBarunpenB.ttf").get_name()
...
lst=['off_acc']
#off_acc1
off_acc1=pd.read_csv("/users/solhee/COVID/off_acc1.csv",parse_dates=["DATE"])
off_acc1.info()
...
#off_cul1
lst=['off_cul']
off_cul1=pd.read_csv("/users/solhee/COVID/off_cul1.csv")
...
#off_food1
lst=['off_food']
off_food1=pd.read_csv("/users/solhee/COVID/off_food2.csv",parse_dates=["DATE"])
...
#off_lei1
lst=['off_lei']
off_lei1=pd.read_csv("/users/solhee/COVID/off_lei1.csv",parse_dates=["DATE"])
...
#off_medi1
lst=['off_medi']
off_medi1=pd.read_csv("/users/solhee/COVID/off_medi1.csv",parse_dates=["DATE"])
...
#off_sani1
lst=['off_sani']
off_sani1=pd.read_csv("/users/solhee/COVID/off_sani1.csv",parse_dates=["DATE"])
...
#on_acc1
lst=['on_acc']
on_acc1=pd.read_csv("/users/solhee/COVID/on_acc1.csv")
...
#on_cul1
lst=['on_cul']
on_cul1=pd.read_csv("/users/solhee/COVID/on_cul1.csv")
...
#on_food1
lst=['on_food']
on_food1=pd.read_csv("/users/solhee/COVID/on_food1.csv")
...
#on_lei1
lst=['on_lei']
on_lei1=pd.read_csv("/users/solhee/COVID/on_lei1.csv")
...
#on_sani
lst=['on_sani']
on_sani1=pd.read_csv("/users/solhee/COVID/on_sani1.csv")
...
accuracy.to_csv("/users/solhee/NEW/LSTM_acc.csv",index=False)
